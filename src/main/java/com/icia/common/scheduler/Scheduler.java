...
public class Scheduler 
{
	...
	public Scheduler() 
	{
		...
		deliveryCompanyList = new JsonParsing().parsingArr(new JsonParsing().readFile("C:/project/webapps/dayiary/src/main/webapp/WEB-INF/views/resources/data/deliveryCompany.json"), "id");
	}
