...
<div style="display:flex; justify-content:space-around;"><img style="width: 250px; height: 100px;" class="logo" src="../resources/images/logo.gif"></div>
    <div class="member">
        <a href="/user/login"></a>
        <h2 style="text-align : center;">판매자아이디 찾기가 완료되었습니다.</h2>
        <h3 style="text-align : center;">가입된 아이디가 총 1개 있습니다.</h3>
        <hr />
       <div class="field">
            <h3><% if (request.getAttribute("sellerId") != null) { %>
    <div style="text-align : center; font-size: 25px;">
        입력한 정보로 조회된 아이디는 <a style="text-decoration : underline; color : pink;"><%= request.getAttribute("sellerId") %></a> 입니다.
    </div>
<% } %></h3>
