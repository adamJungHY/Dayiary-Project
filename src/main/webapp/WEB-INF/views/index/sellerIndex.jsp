   ...
   <div class="app">
      ...
      <div class="cardList">
         ...
         <div class="cards__wrapper">
            <div class="card current--card" data-url="/resto/restoAdd">
               <div class="card__image">
                  <img src="/resources/images/resto.jpg" alt=""/>
               </div>
            </div>

            <div class="card next--card" data-url="/gift/giftAdd">
               <div class="card__image">
                  <img src="/resources/images/gift.png" alt="" />
               </div>
            </div>

            <div class="card previous--card" data-url="/seller/sellerMyPage">
               <div class="card__image">
      ...
      <div class="infoList">
         <div class="info__wrapper">
            ...
            <div class="info current--info">
               <h1 class="text name" style="text-shadow: 5px 2px 5px rgba(0, 0, 0, 0.3);">Restaurant</h1>
               <h4 class="text location" style="letter-spacing: -3px; font-size:35px;">식당 등록</h4>
               <p class="text description">식당 정보를 등록하세요.</p>
            </div>
            
            <div class="info next--info">
               <h1 class="text name" style="text-shadow: 5px 2px 5px rgba(0, 0, 0, 0.3);">Gift</h1>
               <h4 class="text location" style="letter-spacing: -3px; font-size:35px;">선물 등록</h4>
               <p class="text description">선물 정보를 등록하세요.</p>
            </div>

            <div class="info previous--info">
               <h1 class="text name" style="text-shadow: 5px 2px 5px rgba(0, 0, 0, 0.3);">My Page</h1>
               <h4 class="text location" style="letter-spacing: -3px; font-size:35px;">마이페이지</h4>
               <p class="text description">매출 현황 확인 및 정보 수정이 가능합니다.</p>
            </div>
