...
<%@ include file="/WEB-INF/views/include/head.jsp" %>
    ...
    <script>
        ...
        var getBir = new RegExp(/^(19|20)\d{2}(0[1-9]|1[0-2])(0[1-9]|[12]\d|3[01])$/);
        ...
        {     
           ...
           {   
            ...
            $("#userPwd2").on("input", function() 
            {
                ...
                if($("#userPwd1").val() === inputText)
                {
                    ...
                    messageElement.css("color", "#FFFF9C");
            ...
            $("#userBir").on("input", function() 
            {
                var inputText = $(this).val();
                var messageElement = $("#userBirMsg");
         ...
         {   
            ...
            if($("#hiddenBir").val() == null || $("#hiddenBir").val() == "")
            {
               $("#userBirMsg").text("생년월일을 입력하세요");
               $("#userBir").focus();
               return;
            }
            ...
            ({
               type:"POST",
                ...
                { 
                 ...
                 userBir:$("#hiddenBir").val(),
                 userAdd:$("#hiddenAdd").val(),
                 userGen:$("#hiddenGen").val(),
  ...
  bottom: 0;
  left: 0;
  background: url(/resources/images/diary.jpg) center;
...
<div class="container" style="margin-top:10px">
    <form id="reg" name="reg" action="/user/userProc" method="post" style="margin-top: 120px">
        <div class="member">
            <div class="field">
                <div style="text-align: center;">
            <span style="font-size: 36px; color: #000000;"> 일반 회원 가입 </span></div><br><br>
                <b>아이디</b>
            ...
            <div class="field tel-number">
                ...
                <div>
                     ...
                     <input type="button" value="인증메일 받기" id="sendMail">
            ...
            <div class="field">
                <b>닉네임</b>
                <input type="text" placeholder="닉네임을 입력하세요" name="userNickName" id="userNickName">
                <p id="userNickNameMsg">
                    &nbsp;
                </p>
            </div>
            <div class="field">
                <b>생년월일</b>
                <input type="text" placeholder="생년월일 8자리" name="userBir" id="userBir">
                <p id="userBirMsg">
                    &nbsp;
                </p>
            </div>
         ...
         <div class="field">
            ...
            <div class="field gender">
                ...
                <div>
                    <label class="gender">
                        <input type="radio" name="userGen" value="0">
                        <span>남자</span>
                    </label>
                    &nbsp;
                    <label class="gender">
                        <input type="radio" name="userGen" value="1">
                        <span>여자</span>
                    </label>
                </div>
                <p id="userGenMsg">
            ...
            <div class="field tel-number">
                ...
                <div>
                    ...
                    <input type="button" value="인증번호 받기" id="sendMsg">
                ...
                <div>
                    ...
                    <input type="button" value="인증번호 확인" id="chMsg">
                </div>
                <div>
                    <p id="chMsgMsg">
                        &nbsp;
            ...
            <input type="button" value="가입하기" id="btnSubmit" style="background-color: #59689b"/>
        </div>
        ...
        <input type="hidden" name="hiddenBir" id="hiddenBir">
        <input type="hidden" name="hiddenAdd" id="hiddenAdd">
        <input type="hidden" name="hiddenGen" id="hiddenGen">
