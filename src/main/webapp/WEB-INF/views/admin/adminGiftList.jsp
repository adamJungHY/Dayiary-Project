    ...
    $(window).scroll(function() 
    {
    	...
    	if ($(window).scrollTop() + $(window).height() >= $(document).height()) 
        {
        	if(totalCount > endRow)
			{
		        ...
		        getGiftTotalRevenueList(formData, listType);
...
function getGiftTotalRevenueList(formData, listType)
{
	let products = $("#products");
    ...
    ({
        type: "POST",
        url: "/admin/getGiftTotalRevenueList",
        data: formData,
        success: function(response)
        {
        	if(response.code == 0)
...
<div class="container" style="margin-top: 100px; width: 1600px;">
    <div class="well well-sm">
		<div class="btn-group" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <span>
            	<input type="text" id="searchValue" style="width: 250px; height: 29px;" placeholder="상품명을 입력해주세요.">
		            ...
		            <div class="thumbnail">
		                ...
		                <div class="caption">
		                    ...
		                    <p class="group inner list-group-item-text">
		                        ...
		                        총 매출액 : <fmt:formatNumber value="${admin.giftTotalPrice}" pattern="#,###"/>원<br>
		                        가격 : <fmt:formatNumber value="${admin.pPrice}" pattern="#,###"/>원
		                    </p>
		                </div>
		            </div>
		        </div>
